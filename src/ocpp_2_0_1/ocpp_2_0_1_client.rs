...
impl OCPP2_0_1Client {
    ...
    ) -> Result<Result<AuthorizeResponse, OCPP2_0_1Error>, Box<dyn std::error::Error + Send + Sync>>
    {
    ...
    pub async fn send_cleared_charging_limit_request(
        &self,
    ...
    pub async fn send_get_15118_ev_certificate(
        &self,
    ...
    pub async fn send_get_certificate_status(
        &self,
    ...
    ) -> Result<Result<HeartbeatResponse, OCPP2_0_1Error>, Box<dyn std::error::Error + Send + Sync>>
    {
        self.do_send_request(request, "Heartbeat").await
    }

    pub async fn send_log_status_notification(
        &self,
    ...
    ) -> Result<Result<MeterValuesResponse, OCPP2_0_1Error>, Box<dyn std::error::Error + Send + Sync>>
    {
        self.do_send_request(request, "MeterValues").await
    }

    pub async fn send_notify_charging_limit(
        &self,
        request: NotifyChargingLimitRequest,
    ) -> Result<
        Result<NotifyChargingLimitResponse, OCPP2_0_1Error>,
        Box<dyn std::error::Error + Send + Sync>,
    > {
        self.do_send_request(request, "NotifyChargingLimit").await
    }

    pub async fn send_notify_customer_information(
        &self,
        ...
        Box<dyn std::error::Error + Send + Sync>,
    > {
        self.do_send_request(request, "NotifyCustomerInformation")
            .await
    }

    pub async fn send_notify_display_messages(
        &self,
    ...
    pub async fn send_notify_ev_charging_needs(
        &self,
    ...
    pub async fn send_notify_ev_charging_schedule(
        &self,
        ...
        Box<dyn std::error::Error + Send + Sync>,
    > {
        self.do_send_request(request, "NotifyEVChargingSchedule")
            .await
    }

    pub async fn send_notify_event(
        &self,
        request: NotifyEventRequest,
    ) -> Result<Result<NotifyEventResponse, OCPP2_0_1Error>, Box<dyn std::error::Error + Send + Sync>>
    {
        self.do_send_request(request, "NotifyEvent").await
    }

    pub async fn send_notify_monitoring_report(
        &self,
        ...
        Box<dyn std::error::Error + Send + Sync>,
    > {
        self.do_send_request(request, "NotifyMonitoringReport")
            .await
    }

    pub async fn send_notify_report(
        &self,
    ...
    pub async fn send_publish_firmware_status_notification(
        &self,
        ...
        Box<dyn std::error::Error + Send + Sync>,
    > {
        self.do_send_request(request, "PublishFirmwareStatusNotification")
            .await
    }

    pub async fn send_report_charging_profiles(
        &self,
        ...
        Box<dyn std::error::Error + Send + Sync>,
    > {
        self.do_send_request(request, "ReportChargingProfiles")
            .await
    }

    pub async fn send_request_start_transaction(
        &self,
        ...
        Box<dyn std::error::Error + Send + Sync>,
    > {
        self.do_send_request(request, "RequestStartTransaction")
            .await
    }

    pub async fn send_request_stop_transaction(
        &self,
        ...
        Box<dyn std::error::Error + Send + Sync>,
    > {
        self.do_send_request(request, "RequestStopTransaction")
            .await
    }
    ...
    pub async fn send_reservation_status_update(
        ...
        Box<dyn std::error::Error + Send + Sync>,
    > {
        self.do_send_request(request, "ReservationStatusUpdate")
            .await
    }

    pub async fn send_sign_certificate(
        &self,
    ...
    pub async fn send_transaction_event(
        &self,
    ...
    pub async fn on_cancel_reservation<
        ...
        FF: Future<Output = Result<CancelReservationResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_certificate_signed<
        F: FnMut(CertificateSignedRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<CertificateSignedResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_change_availability<
        ...
        FF: Future<Output = Result<ChangeAvailabilityResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_clear_cache<
        ...
        FF: Future<Output = Result<ClearCacheResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_clear_charging_profile<
        ...
        FF: Future<Output = Result<ClearChargingProfileResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_clear_display_message<
        F: FnMut(ClearDisplayMessageRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<ClearDisplayMessageResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
        self.handle_on_request(callback, "ClearDisplayMessage")
            .await
    }

    pub async fn on_clear_variable_monitoring<
        F: FnMut(ClearVariableMonitoringRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<ClearVariableMonitoringResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
        self.handle_on_request(callback, "ClearVariableMonitoring")
            .await
    }

    pub async fn on_cost_updated<
        F: FnMut(CostUpdatedRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<CostUpdatedResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_customer_information<
        F: FnMut(CustomerInformationRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<CustomerInformationResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
        self.handle_on_request(callback, "CustomerInformation")
            .await
    }

    pub async fn on_data_transfer<
        F: FnMut(DataTransferRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<DataTransferResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_delete_certificate<
        F: FnMut(DeleteCertificateRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<DeleteCertificateResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_get_base_report<
        F: FnMut(GetBaseReportRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetBaseReportResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_get_charging_profiles<
        F: FnMut(GetChargingProfilesRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetChargingProfilesResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
        self.handle_on_request(callback, "GetChargingProfiles")
            .await
    }

    pub async fn on_get_composite_schedule<
        F: FnMut(GetCompositeScheduleRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetCompositeScheduleResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_get_display_messages<
        F: FnMut(GetDisplayMessagesRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetDisplayMessagesResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_get_installed_certificate_ids<
        F: FnMut(GetInstalledCertificateIdsRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetInstalledCertificateIdsResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
        self.handle_on_request(callback, "GetInstalledCertificateIds")
            .await
    }

    pub async fn on_get_local_list_version<
        F: FnMut(GetLocalListVersionRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetLocalListVersionResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_get_log<
        F: FnMut(GetLogRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetLogResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_get_monitoring_report<
        F: FnMut(GetMonitoringReportRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetMonitoringReportResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
        self.handle_on_request(callback, "GetMonitoringReport")
            .await
    }

    pub async fn on_get_report<
        F: FnMut(GetReportRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetReportResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_get_transaction_status<
        F: FnMut(GetTransactionStatusRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetTransactionStatusResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
        self.handle_on_request(callback, "GetTransactionStatus")
            .await
    }

    pub async fn on_get_variables<
        F: FnMut(GetVariablesRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetVariablesResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_install_certificate<
        F: FnMut(InstallCertificateRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<InstallCertificateResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_publish_firmware<
        F: FnMut(PublishFirmwareRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<PublishFirmwareResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_reserve_now<
        ...
        FF: Future<Output = Result<ReserveNowResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_reset<
        ...
        FF: Future<Output = Result<ResetResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_send_local_list<
        ...
        FF: Future<Output = Result<SendLocalListResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_set_charging_profile<
        ...
        FF: Future<Output = Result<SetChargingProfileResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_set_display_message<
        F: FnMut(SetDisplayMessageRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<SetDisplayMessageResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_set_monitoring_base<
        F: FnMut(SetMonitoringBaseRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<SetMonitoringBaseResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_set_monitoring_level<
        F: FnMut(SetMonitoringLevelRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<SetMonitoringLevelResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_set_network_profile<
        F: FnMut(SetNetworkProfileRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<SetNetworkProfileResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_set_variable_monitoring<
        F: FnMut(SetVariableMonitoringRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<SetVariableMonitoringResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
        self.handle_on_request(callback, "SetVariableMonitoring")
            .await
    }

    pub async fn on_set_variables<
        F: FnMut(SetVariablesRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<SetVariablesResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_trigger_message<
        ...
        FF: Future<Output = Result<TriggerMessageResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_unlock_connector<
        ...
        FF: Future<Output = Result<UnlockConnectorResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_unpublish_firmware<
        F: FnMut(UnpublishFirmwareRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<UnpublishFirmwareResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    pub async fn on_update_firmware<
        ...
        FF: Future<Output = Result<UpdateFirmwareResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) {
    ...
    #[cfg(feature = "test")]
    pub async fn wait_for_certificate_signed<
        F: FnMut(CertificateSignedRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<CertificateSignedResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<CertificateSignedRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "CertificateSigned")
            .await
    }
    ...
    #[cfg(feature = "test")]
    pub async fn wait_for_clear_display_message<
        F: FnMut(ClearDisplayMessageRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<ClearDisplayMessageResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<ClearDisplayMessageRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "ClearDisplayMessage")
            .await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_clear_variable_monitoring<
        F: FnMut(ClearVariableMonitoringRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<ClearVariableMonitoringResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<ClearVariableMonitoringRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "ClearVariableMonitoring")
            .await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_cost_updated<
        F: FnMut(CostUpdatedRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<CostUpdatedResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<CostUpdatedRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "CostUpdated").await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_customer_information<
        F: FnMut(CustomerInformationRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<CustomerInformationResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<CustomerInformationRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "CustomerInformation")
            .await
    }
    ...
    #[cfg(feature = "test")]
    pub async fn wait_for_delete_certificate<
        F: FnMut(DeleteCertificateRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<DeleteCertificateResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<DeleteCertificateRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "DeleteCertificate")
            .await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_get_base_report<
        F: FnMut(GetBaseReportRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetBaseReportResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<GetBaseReportRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "GetBaseReport")
            .await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_get_charging_profiles<
        F: FnMut(GetChargingProfilesRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetChargingProfilesResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<GetChargingProfilesRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "GetChargingProfiles")
            .await
    }
    ...
    #[cfg(feature = "test")]
    pub async fn wait_for_get_display_messages<
        F: FnMut(GetDisplayMessagesRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetDisplayMessagesResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<GetDisplayMessagesRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "GetDisplayMessages")
            .await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_get_installed_certificate_ids<
        F: FnMut(GetInstalledCertificateIdsRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetInstalledCertificateIdsResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<GetInstalledCertificateIdsRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "GetInstalledCertificateIds")
            .await
    }
    ...
    #[cfg(feature = "test")]
    pub async fn wait_for_get_log<
        F: FnMut(GetLogRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetLogResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<GetLogRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "GetLog").await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_get_monitoring_report<
        F: FnMut(GetMonitoringReportRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetMonitoringReportResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<GetMonitoringReportRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "GetMonitoringReport")
            .await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_get_report<
        F: FnMut(GetReportRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetReportResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<GetReportRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "GetReport").await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_get_transaction_status<
        F: FnMut(GetTransactionStatusRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetTransactionStatusResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<GetTransactionStatusRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "GetTransactionStatus")
            .await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_get_variables<
        F: FnMut(GetVariablesRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<GetVariablesResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<GetVariablesRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "GetVariables").await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_install_certificate<
        F: FnMut(InstallCertificateRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<InstallCertificateResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<InstallCertificateRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "InstallCertificate")
            .await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_publish_firmware<
        F: FnMut(PublishFirmwareRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<PublishFirmwareResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<PublishFirmwareRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "PublishFirmware")
            .await
    }
    ...
    #[cfg(feature = "test")]
    pub async fn wait_for_set_display_message<
        F: FnMut(SetDisplayMessageRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<SetDisplayMessageResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<SetDisplayMessageRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "SetDisplayMessage")
            .await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_set_monitoring_base<
        F: FnMut(SetMonitoringBaseRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<SetMonitoringBaseResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<SetMonitoringBaseRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "SetMonitoringBase")
            .await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_set_monitoring_level<
        F: FnMut(SetMonitoringLevelRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<SetMonitoringLevelResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<SetMonitoringLevelRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "SetMonitoringLevel")
            .await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_set_network_profile<
        F: FnMut(SetNetworkProfileRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<SetNetworkProfileResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<SetNetworkProfileRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "SetNetworkProfile")
            .await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_set_variable_monitoring<
        F: FnMut(SetVariableMonitoringRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<SetVariableMonitoringResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<SetVariableMonitoringRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "SetVariableMonitoring")
            .await
    }

    #[cfg(feature = "test")]
    pub async fn wait_for_set_variables<
        F: FnMut(SetVariablesRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<SetVariablesResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<SetVariablesRequest, Box<dyn std::error::Error + Send + Sync>> {
    ...
    #[cfg(feature = "test")]
    pub async fn wait_for_unpublish_firmware<
        F: FnMut(UnpublishFirmwareRequest, Self) -> FF + Send + Sync + 'static,
        FF: Future<Output = Result<UnpublishFirmwareResponse, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        callback: F,
    ) -> Result<UnpublishFirmwareRequest, Box<dyn std::error::Error + Send + Sync>> {
        self.handle_wait_for_request(callback, "UnpublishFirmware")
            .await
    }
    ...
    async fn handle_on_request<
        ...
        FF: Future<Output = Result<R, OCPP2_0_1Error>> + Send + Sync,
    >(
        &self,
        mut callback: F,
        action: &'static str,
    ...
    async fn do_send_response<R: Serialize>(
        &self,
        response: Result<R, OCPP2_0_1Error>,
        message_id: &str,
    ) {
